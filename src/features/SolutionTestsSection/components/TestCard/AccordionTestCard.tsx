...
import { useAccordionTestCard } from './hooks/useAccordionTestCard'

interface AccordionTestCardProps {
  test: TestDto
}

export const AccordionTestCard = ({ test }: AccordionTestCardProps) => {
  const userContext = useUserContext()
  const { state } = useAccordionTestCard({ testId: test.id! })
