...
import { createPlugins, Plate, PlateLeaf, PlateProps, RenderAfterEditable } from '@udecode/plate-common'
...
interface RichTextEditorProps extends Omit<PlateProps, 'children'> {}
